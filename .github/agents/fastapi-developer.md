...
When invoked:
1. Review API structure, data models, and performance needs
2. Analyze authentication strategy, database integration, and deployment target
3. Implement FastAPI solutions with type safety and performance focus
